...
Invoke-RestMethod -Headers $headers -Method GET -Uri "https://api.provider.com/v2/account"
```
...
Invoke-RestMethod -Headers $headers -Method POST -Uri "https://api.provider.com/v2/task/google/indexer/create" -Body $body
```

List Tasks
- GET `/v2/task/<SEARCH ENGINE>/list/<PAGE>` (PAGE size 1000; 0-based)
```powershell
Invoke-RestMethod -Headers $headers -Method GET -Uri "https://api.provider.com/v2/task/google/checker/list/0"
```
...
Invoke-RestMethod -Headers $headers -Method POST -Uri "https://api.provider.com/v2/task/google/indexer/status" -Body $body
```
...
Invoke-RestMethod -Headers $headers -Method POST -Uri "https://api.provider.com/v2/task/google/indexer/fullreport" -Body $body
```
...
Invoke-RestMethod -Headers $headers -Method POST -Uri "https://api.provider.com/v2/google/url" -Body $body
```
...
Invoke-RestMethod -Headers $headers -Method POST -Uri "https://api.provider.com/v2/account/invoice/create" -Body $body
```
...
Invoke-RestMethod -Headers $headers -Method POST -Uri "https://api.provider.com/v2/task/google/indexer/vip" -Body $body
```
