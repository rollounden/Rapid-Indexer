            ...
            <form method="POST" class="space-y-5">
                ...
                <div>
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <a href="/forgot-password" class="text-xs text-primary-500 hover:text-primary-400">Forgot password?</a>
                    </div>
                ...
                <div class="text-center mt-6">
                    ...
                    <a href="/register" class="font-bold text-primary-500 hover:text-primary-400 ml-1">Create an account</a>
                </div>
            </form>
        </div>
    </div>
