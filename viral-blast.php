    ...
    <section class="relative pt-20 pb-24 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10">
            ...
            <p class="text-xl text-gray-400 max-w-2xl mx-auto mb-12 leading-relaxed">
                Google doesn't just look at links. It looks at user behavior. 
                Our <strong class="text-white">Viral Blast</strong> technology injects randomized, high-retention traffic from social referrers to prove your content is trending.
            </p>
            
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="<?php echo $cta_link; ?>" class="w-full sm:w-auto px-8 py-4 bg-primary-600 text-white font-bold rounded-lg hover:bg-primary-700 transition-all shadow-lg shadow-primary-900/40 text-lg flex items-center justify-center gap-2">
                    <i class="fas fa-bolt"></i> <?php echo $cta_text; ?>
                </a>
                <a href="#formula" class="w-full sm:w-auto px-8 py-4 border border-white/10 text-white font-medium rounded-lg hover:bg-white/5 transition-colors text-lg">
                    See The Formula
                </a>
            </div>
        </div>
